	                  ...
	                  //$.each( data , function( index, item ) {
	                	/* rows += '<tr><td>' + item.id + '</td>';
	          	  		...
	          	  		rows += '<tr><td>' + data.id + '</td>';
	          	  	  	...
	          	  	  	rows += '<td>' + data.age + '</td>';
	          	  	  	rows += '<td>' + data.salary + '</td>';
	          	  		rows += '<td>' + data.dflag + '</td>';
	          	  		rows += '<td onclick="editAjaxData('+data.id+');" >edit</td>';
	          	  		rows += '<td onclick="deleteAjaxData('+data.id+');" >Delete</td></tr>';
...
<body>
	...
	<input id="searchId" type="type" name="searchId"  value=""/>
	<button id="click" onclick="searchId();"> SEARCH</button>
